...
function index() {
  ...
  //     // const response = await axios.post(`http://localhost:3000/recipe/recipes`);
  //   } catch (error) {
  ...
  const submitPhoto = async (e) => {
    ...
    try {
      ...
      console.log("submt photo");
      formData.append("judul", judul);
      formData.append("porsi", porsi);
      formData.append("durasi", durasi);
      formData.append("deskripsi_resep", inspirasi);
      formData.append("foto_recipe", selectedFile);
